...
<body>
    <nav id="" class="navbar  navbar-expand-md fixed-top navbar-shrink py-3">
        <div class="container">
            <div id="navcol-1" class="collapse navbar-collapse">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item"><a class="nav-link" href="#">connecté en tant qu'Admin</a></li>
                </ul>
                            ...
                            <form method="post" action="<?= base_url('index.php/categorie/update') ?>">
                                <select name="categorie">
                                    <optgroup label="Catégories">
                                        ...
                                        <option value="<?=$categories['idCategories'] ?>" <?php if ($categories['idCategories'] == $objet['idCategories']) echo "selected"; ?>><?=$categorie['nom'] ?></option>
                                        <?php } ?>
                                    </optgroup>
                                </select>
                                <input type="hidden" name="objet" value="<?=$objet['idObjet'] ?>">
                                <br>
                                <br>
